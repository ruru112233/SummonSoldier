...
window.gMessageTester = {
	...
	,cssUrl: "./data/others/plugin/theme_kopanda_bth_02/testMessagePlus/style.css"
	,sampleUrl: "./data/others/plugin/theme_kopanda_bth_02/testMessagePlus/sampletext.ks"
